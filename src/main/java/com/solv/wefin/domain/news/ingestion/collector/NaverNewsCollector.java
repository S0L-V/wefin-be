...
public class NaverNewsCollector implements NewsCollector {
    ...
    @Override
    public List<CollectedNewsApiResponse> collect(String category) {
        Map<String, CollectedNewsApiResponse> resultMap = new LinkedHashMap<>();
        List<String> keywords = resolveKeywords(category);

        for (String keyword : keywords) {
            try {
                List<CollectedNewsApiResponse> articles = fetchByKeyword(keyword);
    ...
    private List<CollectedNewsApiResponse> fetchByKeyword(String keyword) {
        ...
        List<CollectedNewsApiResponse> results = new ArrayList<>();
        ...
        for (JsonNode item : items) {
            try {
                ...
                CollectedNewsApiResponse dto = CollectedNewsApiResponse.builder()
