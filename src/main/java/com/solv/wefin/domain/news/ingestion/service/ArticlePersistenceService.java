...
public class ArticlePersistenceService {
    ...
    public boolean processSingleArticle(CollectedNewsApiResponse dto, NewsSource source, NewsCollectBatch batch) {
    ...
    private void normalizeAndSave(RawNewsArticle rawArticle, CollectedNewsApiResponse dto) {
